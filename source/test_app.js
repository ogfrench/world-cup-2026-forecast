...
eq(koActual(koTie({ a: 'Paraguay', b: 'Germany' })), { hs: 1, as: 1, winner: 'Germany', aet: true, pens: [2, 4] },
   'the shootout score orients to the tie order too (a/b reversed from the feed flips the pens)');
