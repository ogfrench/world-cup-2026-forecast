...
def main():
    ...
    # The title-odds podium is intentionally NOT drawn here: those percentages go stale the moment
    # games are played (the live leaders already differ from Day 0), so they make a poor evergreen
    # share card. The card stays just the kicker, the title, and the URL, which never go out of date.
